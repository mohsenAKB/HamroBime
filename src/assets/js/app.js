...
const headerSearchBox = document.querySelector(".header__search-container-box");
const btnCloseSearchBox = document.querySelector(".btn-close");
...
signinBtn.addEventListener("click", popupsigninBtn);
function popupsigninBtn() {
  Swal.fire({
    title: "ورود و ثبت نام",
    confirmButtonText: "ورود",
    showCloseButton: true,
    html:
      '<input  type:tel placeholder="09905779530" class="swal2-input">' 
  });
}
...
function doFade() {
  ...
  tl.to(searchBox, { display: "flex", duration: 0.5 });
}
headerSearch.addEventListener("click", () => {
  headerSearchBox.classList.toggle("d-flex");
